...
function quadrados15() {
    ...
    do {
        ...
        const node = document.createTextNode(`${contadora}² = ${Math.pow(contadora, 2)}`);
...
function segundo() {
    ...
    document.getElementById("titulo-exercicio").innerHTML = "L04B - Soma dos Pares";
    document.getElementById("texto-exercicio").innerHTML = "Exibe a soma dos números pares entre 1 e 500";

    document.getElementById("button").setAttribute('onclick', 'somaPares()');
}
...
function somaPares() {
    ...
    do {
        const parag = document.createElement('p');
        const node1 = document.createTextNode(`${acumuladora} + ${contadora} = `);

        acumuladora += contadora;

        const node2 = document.createTextNode(`${acumuladora}`);

        parag.appendChild(node1);
...
// divisível  por  4,  efetuar  dentro  da  malha  a  verificação  lógica  desta  condição  com  a instrução se,  perguntando 
// se  o  número  é  divisível;  sendo,  mostre-o;  
// não  sendo,  passe  para  o próximo passo. A variável que controlará o contador deve ser iniciada com o valor 1. 
...
function terceiro() {
    ...
    document.getElementById("titulo-exercicio").innerHTML = "L04C - Números Divisíveis por 4";
    document.getElementById("texto-exercicio").innerHTML = "Exibe a soma dos numeros divisiveis por 4 ate 200.";

    document.getElementById("button").setAttribute('onclick', 'divisiveis4()');
}



function divisiveis4() {
    ...
    do {
        ...
        let resto = contadora % 4;

        if (resto == 0) {

            acumuladora = soma;
            soma = contadora + acumuladora;

            const parag = document.createElement('p');
            const node = document.createTextNode(`${contadora} + ${acumuladora} = ${soma}`);
...
// Calcula o total de graos que cabem em um tabuleiro de xadrez. 
...
function quarto() {
    ...
    document.getElementById("titulo-exercicio").innerHTML = "L04D - Grãos no Xadrez";
    document.getElementById("texto-exercicio").innerHTML = "Calcula o total de graos que cabem em um tabuleiro de xadrez";
...
function xadrez() {
    ...
    do {
        ...
        const parag = document.createElement('p');
        const node = document.createTextNode(`Grãos: ${parseFloat(acumuladora)}`);

        parag.appendChild(node);
        document.getElementById('roll').appendChild(parag);

        acumuladora = acumuladora + Math.pow(2, posicao);
console.log(Math.pow(posicao, 2));
    ...
    const parag = document.createElement('p');
    const node = document.createTextNode(`Total de grãos: ${parseFloat(acumuladora)}`);
